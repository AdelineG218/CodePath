...
This app was a bit challenging to build because I needed to set up my development environment (mainly Git and node.js). I also felt like my coding skills were a little rusty. 
