# Web Development Project 4 - *Astronomy Veni Vici*
...
* [x] The user is disabled from clicking the "Discover!" button when it is impossible to generate any more images.Te user must then unban an attribute to continue generating
